...
local Percentage = 0.80 -- Pourcentage sur le prix final, ici le blanchisseur prend 20% (0.80 = 0.20)
local Progress = nil 
                ...
                RageUI.IsVisible(LaundererMenu, function()
                    ...
                    RageUI.Button('Blanchir', false, {RightLabel = "$"..Round(SliderPannel.Index * Percentage), Color = { HightLightColor = { 0, 155, 0, 150 }, BackgroundColor = { 38, 85, 150, 160 } }}, true, {
                        onSelected = function() 
                            ...
                            SetEntityCoords(PlayerPedId(), 605.78,-3072.29,5.07) -- Configuration de la position (Mettre la même partout)
                            Progress = true
...
LaundererPosition = {
    {pos = vector3(605.78,-3072.29,5.07)}, -- Configuration de la position (Mettre la même partout)
}
